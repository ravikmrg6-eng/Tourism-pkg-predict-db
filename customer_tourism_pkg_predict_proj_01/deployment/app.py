...
MaritalStatus = st.selectbox("Marital status of the customer", ["Single", "Married","Divorced"])
...
CityTier = st.number_input("The City category Tier1 or Tier2 or Tier3", min_value=1, max_value=5, value=1, step=1)
